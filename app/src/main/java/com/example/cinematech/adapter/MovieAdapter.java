...
public class MovieAdapter extends RecyclerView.Adapter<MovieViewHolder> {
    ...
    ArrayList<GetMovie> getMovies;
    Activity activity;

    public MovieAdapter(ArrayList<GetMovie> getMovies, Activity activity)
    {
    ...
    public MovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MovieViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.movies_viewholder, parent, false));
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder holder, int position) {
        ...
        holder.moviename.setText(getMovies.get(position).getMoviename());
        Picasso.get().load(getMovies.get(position).getImage()).into(holder.movieimage);
        holder.imbdrating.setText(getMovies.get(position).getImbd());
        holder.moviedate.setText(getMovies.get(position).getReleasedate());
